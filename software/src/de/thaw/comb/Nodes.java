...
public final class Nodes {
	 ...
	 * coordinates.
	 */
	public static Node createWithDistanceBearing (final PlaneCoordinates node, final double distance, final double bearing) {
	 ...
	 */
/* 
	public static Node createWithDistanceBearing (final PlaneCoordinates node, final Vector vector) {
...
*/
	 ...
	 */
	public static Node createAtMidPoint (final PlaneCoordinates node, final Vector vector) {
