...
% anstatt des Analyser-Outputs ist tatsächlich eher der CorrelationGraph das Analyseergebnis
...
% an dieser Stelle außerdem Überleitung (?): was kann man aus 2.5 für lehren/erkenntnisse ziehen? irgendwas anwendbares dabei? wenn ja, warum nicht?
...
Grundprinzip: zu jedem Node, der Teil zweier zusammenzufassender Linienzüge ist, ein passendes Gegenüber auf dem anderen Linienzug finden, dann die Mittelpunkte zwischen diesen Nodes bestimmen und zu einem neuen Linienzug zusammensetzen
