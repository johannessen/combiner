...
% -> theoretisch keine Rolle, weil durch die beidseitige Relation reziproke Zuordnung möglich ist, aber Randfälle insb. an Kreuzungen sind denkbar. Testen!
...
\end{algorithmic}
\end{algorithmhere}
% implementiert in CorrelationGraph.createGraph()
