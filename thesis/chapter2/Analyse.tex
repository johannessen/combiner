...
von etwa \ThousandsScale[000]{2} bis \ThousandsScale[~\unit{Mio.}]{500} angeboten werden. \cf[154–155]{RT09}
...
\twofigures{ht}{
	...
	\end{overpic}
	\caption
		[Trollstigen, Web-Karte mit \osm-Daten, \ThousandsScale{135}]
		{Trollstigen, Web-Karte mit \osm-Daten, \ThousandsScale{135} \citex{map:thunderforest}}
	...
	\caption
		[Trollstigen, manuell kartographisch generalisiert, \ThousandsScale{135}]
		{Trollstigen, manuell kartographisch generalisiert, \ThousandsScale{135} \citex{map:n250}}
...
Beispielsweise könnte beim Zusammenfassen paralleler Gleise die in \osmtag{tracks} vermerkte Gleisanzahl der zuvor getrennten \term{ways} für das generalisierte Ergebnis addiert werden (vgl. Abschnitt~\ref{railway-case}).
...
Der Algorithmus von \citeauthor{EE99} \cf{EE99} musste für die ALK-Daten angepasst und erweitert werden, um das resultierende Straßennetz auf die gewünschten Mittellinien der Flächen zu reduzieren.
...
Hierzu benutzt Migurski die Software Skeletron. \cf{Mig12,ME11}
