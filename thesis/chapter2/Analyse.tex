...
Chaudry und Mackaness schlagen das Konzept von \term{strokes} zur Generalisierung von Straßennetzen für die digitale OS~MasterMap des Ordnance Survey vor. Sie betonen jedoch, dass trotz ermutigender Resultate noch weitere Probleme gelöst werden müssen. Auf die Eigenschaft der Parallelität gehen sie nicht ein. \cf{CM05}
...
Thom beschreibt eine Methode zum Zusammenfassen getrennter Richtungsfahrbahnen von Schnellstraßen auf eine gemeinsame Mittellinie für die OS~MasterMap.
...
