...
In Deutschland erfasst die \osm-\term{community} autobahnähnliche Straßen als \tag{highway=trunk}. Allerdings bildet die \osm-Straßenklassifizierung das britische System ab, wo \term{trunk} auch für schmalere Landstraßen ohne besonderen Ausbauzustand verwendet wird. Gleiches gilt u.~a. für Norwegen (\term{riksveg}, Abbildung~\ref{fig:trunk-norway}).

\begin{figure}[ht]
    \centering
    \includegraphics[width=\ScaleIfNeeded]{../image-missing}
    \caption{trunk in NO}\label{fig:trunk-norway}
\end{figure}
...
\begin{figure}[ht]
    ...
    \caption{utrecht14}\label{fig:utrecht14}
\end{figure}
\begin{figure}[ht]
    \centering
    \includegraphics[width=\ScaleIfNeeded]{utrecht-z15}
    \caption{utrecht15}\label{fig:utrecht15}
\end{figure}
\begin{figure}[ht]
    \centering
    \includegraphics[width=\ScaleIfNeeded]{gera-z13}
    \caption{gera13}\label{fig:gera13}
\end{figure}
\begin{figure}[ht]
    \centering
    \includegraphics[width=\ScaleIfNeeded]{gera-z14}
    \caption{gera14}\label{fig:gera14}
\end{figure}
