...
\twofigures{ht}{
	...
	\caption{Trollstigen, Web-Karte mit \osm-Daten, \term{zoom}~11 (©~Thunderforest)}
	\label{fig:trollstigen-osm}
}{
	
	\includegraphics[width=\ScaleIfNeeded]{../chapter2/trollstigen-kartverket-z11}
	% TODO: replace Kartverket placeholder with custom-made example
	% this example may be at a different scale than the OSM image!
	\label{fig:trollstigen-manual}
	\caption{Trollstigen, manuell kartographisch generalisiert, \term{zoom} 11 (Platzhalter, ©~Kartverket)}
}
...
\onefigure{hbt}{
	...
	\caption{Überkreuzen paralleler Linienzüge nach Vereinfachung mit Ramer-Douglas-Peucker}
}
...
\begin{figure}[ht]
  ...
  \begin{minipage}[t]{.5\linewidth}
    ...
    \caption{kombinierte Signaturen für autobahnähnliche Straßen mit Anschlussstelle}\label{fig:dual-carriageway}
  \end{minipage}
\end{figure}
