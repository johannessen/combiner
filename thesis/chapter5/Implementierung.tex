...
\onefigure{ht}{
	...
	\caption
		...
		{Komponenten der entwickelten Software (schwarz: eigene Entwicklung, blau: benutztes \term{framework})}
...
% Fußnote: In der später erschienen Version xy von GeoTools ist der Shapefile-Support neu implementiert ...
...
Beispielsweise werden in den Implementierungen der Algorithmen \textproc{Fußpunkt} und \textproc{Analyse} zahlreiche neue Vektoren-Objekte erzeugt, die jeweils nur für eine einzige geometrische Berechnung benötigt werden.
