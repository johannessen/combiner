...
% roads-motorway.shp
Die entwickelte Software erkennt $\unit[4460]{km}$ davon als parallel; das ausgegebene Ergebnis besteht zu $\unit[97,6]{\%}$ aus zusammengefassten Linienzügen.
...
\begin{itemize}[nosep]
\item fehlerhafte Klassifizierung (insb. \osmtag{highway}[motorway] statt \term{motorway\_link})
\item fehlerhafte Attribute (\osmtag{ref} einseitig fehlend oder voneinander abweichend)
