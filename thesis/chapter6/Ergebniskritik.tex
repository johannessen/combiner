...
Von der Präsenz anderer, nicht paralleler Linienzüge lassen sich die Algorithmen dabei nicht beeinflussen (\textfiguremark{4}).

Nähere Betrachtung des scharfen Knicks im nachgeordneten Netz offenbart dagegen einige Probleme.
...
\twofigures{p}{
	\begin{overpic}[width=\ScaleIfNeeded]{../chapter6/result-trivial-detail-L124}
		...
		\put(111,55){\figuremark{3}}
		\put(166,52){\figuremark{4}}
	\end{overpic}
	% 1:7500 Google Mercator, bbox 779845 6607935 780370 6608240
	\caption{Punktezuordnungen für \textfiguremark{1}~in Abbildung~\ref{fig:result-trivial}}
	...
	\caption{Punktezuordnungen für \textfiguremark{2}~in Abbildung~\ref{fig:result-trivial} (Darstellung rotiert)}
