...
in der Geodatenbank PostGIS ein, die anhand eines \term{straight skeleton} ein Polygon auf dessen Mittellinie reduziert (siehe Abschnitt~\ref{ch:skeleton}).
...
%\end{itemize}
%nach Kreunzungs-Lösung: lösbares Problem, verschiedene Ansätze, im Wesentlichen eine Frage der Optimierung und der geschickten Ausnutzung der vorhandenen Attribute, vgl. Thom
%
